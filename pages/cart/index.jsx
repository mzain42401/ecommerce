                ...
                <div class="flex flex-wrap items-center mb-6 -mx-4 md:mb-8">
                  <div class="w-full px-4 mb-6 md:w-4/6 lg:w-6/12 md:mb-0">
                    <div class="flex flex-wrap items-center -mx-4">
                      ...
                      <div class="w-2/3 px-4">
                        <h2 class="mb-2 text-xl font-bold text-gray-800">DSL Camera</h2>
                        <p class="text-gray-500 dark:text-gray-400 ">Picture frame</p>
                        <p class="text-gray-500 dark:text-gray-400 md:hidden ">Rs.99/-</p>

                      </div>
                    </div>
                  </div>
                  <div class="hidden px-4 lg:block lg:w-2/12">
                    <p class="text-lg font-bold  text-gray-800">$100.00</p>
                  ...
                  <div class="w-auto px-4 md:w-1/6 lg:w-2/12 ">
                    <div
                      ...
                      <button class="py-2 hover: dark:text-gray-400">
                      ...
                      <input type="number"
                        class="w-12 px-2 py-4 text-center border-0 rounded-md  bg-gray-50 md:text-right"
                        placeholder="1" />
                      <button class="py-2 hover: dark:text-gray-400">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                  ...
                  <div class="w-auto px-4 text-right md:w-1/6 lg:w-2/12 ">
                    ...
                    <p class="text-lg font-bold text-gray-800">$99.00</p>
                  </div>
                </div>
              ...
              <div class="w-full px-4 mb-4 lg:w-1/2 ">
                <div class="p-6 border border-blue-100 bg-gray-300 rounded  md:p-8">
                  ...
                  <div class="flex items-center justify-between pb-4 mb-4 ">
                    ...
                    <span class="text-xl font-bold text-gray-900">$99.00</span>
                  </div>
