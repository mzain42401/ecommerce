  ...
  return (
    ...
    <div className='navToggleBtn hidden text-xl cursor-pointer' onClick={toggleIcons}>
      ...
      <div className='flex  items-center font-bold'>
        <div className='px-2 text-2xl cursor-pointer'><Link href='/profile'><AiOutlineUser/></Link></div>
        <div className='px-1 text-2xl cursor-pointer relative'>
         <Link href='/cart'> <AiOutlineShoppingCart/> <sup className='absolute bg-slate-200 h-4 w-4 right-[-5px] top-[-12px] rounded-full flex justify-center items-center text-xs'>2</sup>
         </Link></div>
