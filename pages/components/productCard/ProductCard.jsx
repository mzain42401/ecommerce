...
const ProductCard = () => {
  return (
    <>
    <Link href='/products/aa'>
      <div style={{"transition-duration": "950ms"}} className='relative mx-1 my-8 bg-white w-60 h-[350px] py-2  px-2 hover:translate-y-[-20px] rounded-lg'>
