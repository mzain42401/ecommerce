...
<div><Link href='/'>back to home</Link> </div>
    ...
    <div className='relative w-3/4 m-auto mt-4'>
      
      <div className="mt-6 border p-6 rounded-xl border-gray-300">
        ...
        <div className=' absolute bottom-2 bg-orange-700 px-5 py-1 rounded-lg right-4'>
      ...
      <ul role="list" className="divide-y w-[79%] m-auto divide-gray-100">
      {people.map((person) => (
